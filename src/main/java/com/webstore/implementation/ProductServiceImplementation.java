...
public class ProductServiceImplementation implements ProductService {
    ...
    private ProductResponseDto convertToDto(Product product) {
        ...
        if (product.getSeller() != null) {
            ...
            // Fallback: fetch seller_id directly from database if seller relationship is not loaded
            log.warn("Seller relationship not loaded for product {}, fetching seller_id directly", product.getProductId());
