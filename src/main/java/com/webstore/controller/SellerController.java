...
public class SellerController {
    ...
    public ResponseEntity<List<SellerResponseDto>> getAllSellers() {
        log.info("GET /api/sellers - Fetching all sellers");
        
        List<SellerResponseDto> sellers = sellerService.getAllSellers();
        
        // Return 200 OK with list of sellers (can be empty)
    ...
    * Endpoint: DELETE /api/sellers/{id}*/
     ...
     *Endpoint: GET /api/sellers/joined-between?startDate=2024-01-01&endDate=2024-12-31*/
